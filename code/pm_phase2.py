#!/usr/bin/env python3
"""
PhysioMind Phase 2: do text-SAE features track real autonomic
physiology (WESAD chest ECG), or just look like they do?
...
OUT = "/data/experiments/physiomind/phase2_result.json"
